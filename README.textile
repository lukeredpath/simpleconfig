...
We are still working on setting up a Subversion mirror for our code so in the meantime you can "download the plugin as a zip archive":/assets/2008/7/3/simple_config.zip.
